...
locals {
  ...
  staging_slot_app_settings = var.staging_slot_custom_app_settings == null ? local.app_settings : merge(local.local_app_settings, var.staging_slot_custom_app_settings)
}
