...
variable "image_name" {
  type = string
  validation {
    condition = can(contains(["GESOS-AZ-BASE-ORACLELINUX8", "GESOS-AZ-BASE-RHEL8"], var.image_name))
    error_message = "Tne image_name variable must be one of [ GESOS-AZ-BASE-ORACLELINUX8, GESOS-AZ-BASE-RHEL8]."
  }
}
...
variable "user_identity_ids" {
  type = list(string)
  description = "User identities to attach to this vm. Centralized identity added by default. This is the entire resource id i.e. /subscriptions/9c1ab385-2554-43ca-bdf8-f8d937bf4a28/resourceGroups/rg-328-uai3046421-common/providers/Microsoft.ManagedIdentity/userAssignedIdentities/mi-328-linux-common"
  default = []
}
...
variable  "MaintenanceSchedule" {
  ...
  validation {
    ...
    error_message = "The MaintenanceSchedule variable must be one of [(Non Prod Linux:MO-WK1-SA-0000,MO-WK1-SA-1200,MO-WK1-TH-0000,MO-WK1-TH-1200), (Non Prod Windows and Prod Linux:MO-WK2-SA-0000,MO-WK2-SA-1200,MO-WK2-TH-0000,MO-WK2-TH-12000, (Prod Windows:MO-WK3-SA-0000, MO-WK3-SA-1200,MO-WK3-TH-0000,MO-WK3-TH-1200)]."
  }
}
