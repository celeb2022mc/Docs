## Module Azure Linux App Services

Used to create Azure App Services Linux Based OS.
...
| 1.1     | 1.1     | Fixed the wiz vulnerability- Identity settings   | N/A                         |
...
| app_service_plan                         | string       | Linux app_service_plan for the app service             					                  | app-lx-uai3026350-dev-test                                                               | no        |
...
| privatedns				      | string       | privatedns for private end point, private zone must be integrated with vnet     			                              | privatelink.azurewebsites.net			  									   | no        |
