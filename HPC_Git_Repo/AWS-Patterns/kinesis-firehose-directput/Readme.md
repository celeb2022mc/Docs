...
### Sample 
- kinesis-firehose-directput.cf.yml
```yaml
...
DeliveryStreamName: test  #Description: The name to use for the service Kinesis Firehose
...
RoleARN: arn:aws:iam::992382426084:role/vn/bot-lawgiver  #Description: ARN of the IAM Role

CompressionFormat:  #Description: Compression Format
...
ProcessorsType:  MetadataExtraction  #Description: Processor Type

ProcessorsParameterName: MetadataExtractionQuery  #Description: Processor Type Name
...
UAI:
  ...
  ProcessorsParameterValue:
      ...
      Default: '{YYYY : (.ts/1000) | strftime("%Y"), MM : (.ts/1000)
                ...
                | strftime("%H")}'DD : (.ts/1000) | strftime("%d"), HH: (.ts/1000)
                | strftime("%H")}' 
```
